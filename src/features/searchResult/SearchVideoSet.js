...
import "./SearchVideoSet.css";
import Post from "../post/Post";

const SearchVideoSet = () => {
  return (
    <div className="searchVideoSet">
      <div className="searchVideoSet__post">
        <Post
          hashtag={["coding", "web", "javascript", "react"]}
          email="gognumb2000@gmail.com"
          description="Coding is such a magic things !."
          username="Khemmapich"
